...
In order to create a string, first fix a set $A$ of symbols which represent the times and events under discussion, such that each $a \in A$ will be understood as naming an event or time. The powerset of $A$ will serve as a finite alphabet $\Sigma = 2^A$ of a string $s \in \Sigma^*$.

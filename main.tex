...
Strings of symbols representing events as described in \cref{ssub:creating} may be interpreted as finite models of Monadic Second-Order Logic (MSO) \nb{In transfer I just pointed the reader towards \citet{Libkin2012} for a discussion -- should maybe go into at least some small detail in the main text this time?}.
...
% L = [[[a,c],[a,b,c],[a,c,d],[b,c,d]], [[a,c],[a,b,c],[b,c,d]], [[a,c],[a,b,d],[b,c,d]] ,[[a,c],[b,c,d]]].

\begin{align}\label{ex:async-superposition}
	\EventString{a,c|b,d} \spasync \EventString{a|b,c|c,d} = \{&\EventString{a,c|a,b,d|b,c,d}, \EventString{a,c|a,b,c|b,c,d},\\&\EventString{a,c|a,b,c|a,c,d|b,c,d}, \EventString{a,c|b,c,d}\}\notag
\end{align}

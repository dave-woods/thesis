...
The \textit{vocabulary} $\mathcal{V}$ of a string or language is the set of fluents which appear in it. For an arbitrary string $s = \sigma_1\sigma_2\cdots\sigma_n$, the vocabulary $\mathcal{V}_s$ of $s$ may be determined by taking the union of the string's components:
\begin{align}
